...
namespace AMPMVC5.Models
{
    public class AMPEvents
    {
        ...
        public static List<AMPEvents> LoadAppointmentSummaryInDateRange(double start, double end)
        {
        ...
        public static bool CreateNewEvent(string Title, string NewEventDate, string NewEventTime, string NewEventDuration)
        {
            ...
            //    rec.title = Title;
            //    rec.start = DateTime.ParseExact(NewEventDate + " " + NewEventTime, "dd/MM/yyyy HH:mm", CultureInfo.InvariantCulture);
